...
public class ValidationLevel implements java.io.Serializable {
    ...
    public static final ValidationLevel SEVERE = new ValidationLevel(_SEVERE);
    public static final ValidationLevel WARNING = new ValidationLevel(_WARNING);
    public static final ValidationLevel INFO = new ValidationLevel(_INFO);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ephyto.ippc.int/", "validationLevel"));
    }
    /**
