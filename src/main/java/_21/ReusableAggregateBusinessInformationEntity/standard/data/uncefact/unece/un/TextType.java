...
public class TextType  implements java.io.Serializable, org.apache.axis.encoding.SimpleType {
    ...
    /**
     * Gets the languageID value for this TextType.
     * 
     * @return languageID
     */
    ...
    /**
     * Sets the languageID value for this TextType.
     * 
     * @param languageID
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:21", "textType"));
